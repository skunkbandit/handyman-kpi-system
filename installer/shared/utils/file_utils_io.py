"""File System IO Utilities for the KPI System Installer

This module provides utilities for file reading and writing operations
across different formats like text, JSON, and INI.
"""
